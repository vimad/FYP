...
class Quadcopter:
    ...
    def __init__(self, connection_string = None, vehicle = None, baud = 57600):
        if not vehicle is None:
            self.vehicle = vehicle          #- Using the provided vehicle

        elif not connection_string is None:
            self._connect(connection_string = connection_string, baud = baud)    #- Using the provided Connection string
    ...
    def _connect(self, connection_string, baud):
